                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <select class="form-control select2" v-model="stock.category" v-select="stock.category"
                      @change="findProduct()">
                      <option value style="display: none;">Selecciona una categoría</option>
                  ...
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <select class="form-control select2" v-model="stock.product" v-select="stock.product">
                        <option value="" style="display: none;">Selecciona un producto</option>
                        <option v-for="(value, index) in products" :value="value.id">{{ value.name }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <select class="form-control select2" v-model="stock.vendor" v-select="stock.vendor">
                        <option value style="display: none;">Selecciona un proveedor</option>
