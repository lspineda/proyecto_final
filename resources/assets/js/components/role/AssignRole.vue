			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Permiso de <span style="color: teal">{{
							role.name
						}}</span></h4>
					</div>
								...
								<div class="col-md-12">
									...
									<div class="demo-checkbox" v-for="(value, index) in role.menus" :key="index">
										...
										<div class="col-md-12">
											...
											<div class="switch">
												<label v-if="value.sub_menu.length === 0"><input :value="value.id"
														:id="value.id" v-model="value.check" type="checkbox" checked><span
										...
										<div class="col-md-4" v-for="sub in value.sub_menu">
											...
											<div class="switch">
												<label><input :value="sub.id" :id="sub.id" v-model="sub.check"
