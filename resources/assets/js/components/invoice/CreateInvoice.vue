          ...
          <div class="row">
              ...
              <div class="input-group">
                ...
                <div class="form-line">
                  <select class="form-control" v-model="invoice.customer_type">
                    <option value style="display: none;">Seleccionar cliente</option>
            ...
            <div class="col-md-6" v-if="invoice.customer_type == 1">
              <div class="input-group">
                ...
                <div class="form-line">
                  <multiselect v-model="invoice.customer_id" deselect-label="" track-by="id" label="name"
                  ...
                  <tr v-for="(vl, index) in invoice.product">
                    ...
                    <td>
                      <multiselect v-model="invoice.product[index].category" deselect-label="" track-by="id" label="name"
                        open-direction="bottom" placeholder="Seleccionar categoría" :options="categorys"
                    ...
                    <td>
                      <multiselect v-model="invoice.product[index].product_id" deselect-label="" track-by="id"
                        label="name" open-direction="bottom" placeholder="Seleccionar producto"
                    ...
                    <td>
                      <select class="form-control" v-model="invoice.product[index].chalan_id"
                        ...
                        <option value style="display: none;">Seleccionar Comprobante</option>
