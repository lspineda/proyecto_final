          ...
          <form @submit.prevent="Payment()">
            ...
            <div class="modal-body">
              ...
              <div class="form-inline">
                ...
                <vuejs-datepicker :input-class="'width form-control'" :format="'yyyy-MM-dd'"
                  v-model="payment.payment_date"></vuejs-datepicker>
              </div>

              <div class="form-inline" style="margin-top: 10px;">
                <p>Importe</p>
                <input style="width: 100%;" type="text" class="form-control" name="" placeholder="Importe"
