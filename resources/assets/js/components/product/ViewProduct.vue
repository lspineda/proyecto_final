        ...
        <table class="table table-condensed table-hover">
          ...
          <tbody>
            <tr v-for="(value, index) in products.data">
              ...
              <td>
                <div
                  style="width: 650px; text-align: justify; height: 40px; white-space: normal; text-overflow: ellipsis; overflow: hidden;">
                  {{ value.details }}</div>
              </td>
              <td class="align-center">
                <button @click="editProduct(value.id)" type="button"
                  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                  <i class="material-icons">edit</i>
                </button>
              </td>
              <td class="align-center">
                <button @click="deleteProduct(value.id)" type="button"
