...
class RoleController extends Controller
{
    ...
    public function Permission(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'success', 'message' => '¡Nuevo permiso otorgado!']);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json(['status' => 'success', '¡Rol eliminado!']);
        } catch (\Exception $e) {
            return response()->json(['status' => 'error', '¡Algo salió mal! Por favor, vuelva a intentarlo']);
        }
    }
}
